---
lastRevised: February 2026
tldr: "We collect anonymous page view and upvote counts. We don't use ad trackers, don't sell data, and don't store any personal information on our servers. If you subscribe to the newsletter, your email is handled by Substack."
sections:
  - title: "What we collect"
    body:
      ...
      - "If you use the newsletter signup form, your email address is processed by Substack, our third-party email provider. We do not store your email on our own servers. See Substack's privacy policy at substack.com/privacy."
  ...
  - title: "Third-party services"
    body:
      ...
      - "Substack — If you subscribe to the newsletter, your email is stored with Substack. You can unsubscribe at any time using the link in any email we send."
  - title: "Data retention"
    body:
      ...
      - "Newsletter subscriptions are retained until you unsubscribe. You can request deletion of your email from Substack at any time."
  - title: "Your rights"
    body:
