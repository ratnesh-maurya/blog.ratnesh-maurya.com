...
featured: false
questions: ["How to give Cursor AI an expert persona?", "What is cursor-claude-personas?", "How to make Claude Code follow project rules?", "What are `.claude` and `.cursor` rules?"]
slug: "cursor-claude-personas-give-your-ai-coding-assistant-a-domain-expert-brain-in-30-seconds"
---
