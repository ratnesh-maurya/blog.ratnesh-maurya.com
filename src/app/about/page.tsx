...
const socials = [
  ...
  { label: 'Twitter / X', href: 'https://x.com/_ratneshmaurya', icon: 'M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z' },
];
...
const aboutFAQ = [
  ...
  },
  {
    ...
    answer: 'You can reach Ratnesh on LinkedIn (linkedin.com/in/ratnesh-maurya), Twitter/X (@_ratneshmaurya), or GitHub (github.com/ratnesh-maurya). For professional inquiries and full-time or contract roles, his portfolio at ratnesh-maurya.com has contact details.',
  },
  {
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10 md:py-16 space-y-16">
          ...
          <section className="rounded-2xl p-8 text-center"
            ...
            <div className="flex flex-wrap gap-3 justify-center">
              ...
              <a href="https://x.com/_ratneshmaurya" target="_blank" rel="noopener noreferrer"
